...
function updateBackgroundBerlin() {
  ...
  if (currentHourBerlin >= 0 && currentHourBerlin < 1) {
    ...
    gradient = "radial-gradient(ellipse at top left, #101010, #101010)"; // 1AM to 2AM
  } else if (currentHourBerlin >= 2 && currentHourBerlin < 3) {
    gradient = "radial-gradient(ellipse at top left, #202020, #202020)"; // 2AM to 3PM
  } else if (currentHourBerlin >= 3 && currentHourBerlin < 4) {
    gradient = "radial-gradient(ellipse at top left, #303030, #303030)"; // 3AM to 4AM
  } else if (currentHourBerlin >= 4 && currentHourBerlin < 5) {
    gradient = "radial-gradient(ellipse at top left, #404040, #404040)"; // 4AM to 5AM
  } else if (currentHourBerlin >= 5 && currentHourBerlin < 6) {
    gradient = "radial-gradient(ellipse at top left, #505050, #505050)"; // 5AM to 6AM
  } else if (currentHourBerlin >= 6 && currentHourBerlin < 7) {
    gradient = "radial-gradient(ellipse at top left, #606060, #606060)"; // 6AM to 7AM
  } else if (currentHourBerlin >= 7 && currentHourBerlin < 8) {
    gradient = "radial-gradient(ellipse at top left, #696969, #696969)"; // 7AM to 8AM
  } else if (currentHourBerlin >= 8 && currentHourBerlin < 9) {
    gradient = "radial-gradient(ellipse at top left, #787878, #787878)"; // 8AM to 9AM
  } else if (currentHourBerlin >= 9 && currentHourBerlin < 10) {
    gradient = "radial-gradient(ellipse at top left, #888888, #888888)"; // 9AM to 10AM
  } else if (currentHourBerlin >= 10 && currentHourBerlin < 11) {
    gradient = "radial-gradient(ellipse at top left, #989898, #989898)"; // 10AM to 11AM
  } else if (currentHourBerlin >= 11 && currentHourBerlin < 12) {
    gradient = "radial-gradient(ellipse at top left, #A8A8A8, #A8A8A8)"; // 11AM to noon
  } else if (currentHourBerlin >= 12 && currentHourBerlin < 13) {
    gradient = "radial-gradient(ellipse at top left, #B0B0B0, #B0B0B0)"; // noon to 1PM
  } else if (currentHourBerlin >= 13 && currentHourBerlin < 14) {
    gradient = "radial-gradient(ellipse at top left, #C8C8C8, #C8C8C8)"; // 1PM to 2PM
  } else if (currentHourBerlin >= 14 && currentHourBerlin < 15) {
    gradient = "radial-gradient(ellipse at top left, #DCDCDC, #DCDCDC)"; // 2PM to 3PM
  } else if (currentHourBerlin >= 15 && currentHourBerlin < 16) {
    gradient = "radial-gradient(ellipse at top left, #F5F5F5, #F5F5F5)"; // 3PM to 4PM
  } else if (currentHourBerlin >= 16 && currentHourBerlin < 17) {
    gradient = "radial-gradient(ellipse at top left, #DCDCDC, #DCDCDC)"; // 4PM to 5PM
  } else if (currentHourBerlin >= 17 && currentHourBerlin < 18) {
    gradient = "radial-gradient(ellipse at top left, #C8C8C8, #C8C8C8)"; // 5PM to 6PM
  } else if (currentHourBerlin >= 18 && currentHourBerlin < 19) {
    gradient = "radial-gradient(ellipse at top left, #B0B0B0, #B0B0B0)"; // 6PM to 7PM
  } else if (currentHourBerlin >= 19 && currentHourBerlin < 20) {
    gradient = "radial-gradient(ellipse at top left, #A8A8A8, #A8A8A8)"; // 7PM to 8PM
  } else if (currentHourBerlin >= 20 && currentHourBerlin < 21) {
    gradient = "radial-gradient(ellipse at top left, #989898, #989898)"; // 8PM to 9PM
  } else if (currentHourBerlin >= 21 && currentHourBerlin < 22) {
    gradient = "radial-gradient(ellipse at top left, #888888, #888888)"; // 9PM to 10PM
  } else if (currentHourBerlin >= 22 && currentHourBerlin < 23) {
    gradient = "radial-gradient(ellipse at top left, #303030, #303030)"; // 10PM to 11PM
  } else {
    gradient = "radial-gradient(ellipse at top left, #202020, #202020)"; // 11PM to Midnight
  }
